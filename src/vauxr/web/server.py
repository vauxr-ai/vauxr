...
from vauxr.devices.config import VALID_PIPELINE_MODES, pipeline_mode, VALID_FOLLOW_UP_MODES, parse_button_actions
...
async def announce(request: web.Request) -> web.Response:
    ...
    from vauxr.buttons import announce_to_device
...
def attach_http_routes(app: web.Application) -> None:
    from vauxr.web.speech import attach_speech_routes
